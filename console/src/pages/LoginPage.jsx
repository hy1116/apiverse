...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const { data } = await client.post('/admin/auth/login', { email: form.email, password: form.password })
      login(data)
      navigate('/dashboard')
    } catch (err) {
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">관리자 로그인</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ADMIN 계정으로만 접근할 수 있습니다
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="admin@apiverse.com"
